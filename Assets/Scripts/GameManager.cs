...
public class GameManager : MonoBehaviour
{
    ...
    [SerializeField]
    private Vector3 _obstacleTopSpawnPos, _obstacleBottomSpawnPos;
    ...
    private IEnumerator SpawnObstacles()
    {
        ...
        Vector3 spawnPos = isTop ? _obstacleTopSpawnPos : _obstacleBottomSpawnPos;
        Vector3 spawnRot = isTop ? new Vector3(0,0,180f): Vector3.zero;
        while (!hasGameEnded)
        {            
            Instantiate(_obstaclePrefab,spawnPos,Quaternion.Euler(spawnRot));
            isTop = UnityEngine.Random.Range(0, 2) == 0;
            spawnPos = isTop ? _obstacleTopSpawnPos : _obstacleBottomSpawnPos;
